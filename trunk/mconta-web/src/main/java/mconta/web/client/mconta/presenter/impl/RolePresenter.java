...
import mconta.web.client.mconta.event.RoleEvent;
import mconta.web.client.mconta.event.UserEvent;
import mconta.web.client.mconta.event.UserEvent.UserHandler;
import mconta.web.client.mconta.presenter.CrudPresenter;
import mconta.web.client.mconta.rpc.AppAsyncCallback;
import mconta.web.client.mconta.rpc.CrudService;
import mconta.web.client.mconta.rpc.CrudServiceAsync;
import mconta.web.client.mconta.view.CrudView;
